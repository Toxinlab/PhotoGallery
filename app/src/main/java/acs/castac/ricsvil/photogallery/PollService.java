...
public class PollService extends IntentService {
    ...
    public static final String ACTION_SHOW_NOTIFICAITON = "acs.castac.ricsvil.photogallery.SHOW_NOTIFICATION";
    public static final String PERM_PRIVATE = "acs.castac.ricsvil.photogallery.PRIVATE";
    ...
    private void showBackgroundNotification(int i, Notification notification) {
        Intent intent = new Intent(ACTION_SHOW_NOTIFICAITON);
