...
public class ThumbnailDownloader<T> extends HandlerThread {
    ...
    public void setmThumbnailDownloaderListener(ThumbnailDownloaderListener<T> listener){
    ...
    private void handleRequest(final T target){
        try{
            ...
            byte[] bitmapByres = new FlickrFetchr().gerUrlBytes(url);
            final Bitmap bitmap = BitmapFactory.decodeByteArray(bitmapByres, 0 , bitmapByres.length);
